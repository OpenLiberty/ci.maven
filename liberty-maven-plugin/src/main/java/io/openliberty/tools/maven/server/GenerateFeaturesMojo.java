...
public class GenerateFeaturesMojo extends InstallFeatureSupport {
    ...
    protected static final String FEATURES_FILE_MESSAGE = "Features have been generated in " + PLUGIN_ADDED_FEATURES_FILE;
    ...
    private ServerConfigDropinXmlDocument getServerXmlDocFromConfig(File serverXml) {
        if (serverXml == null || !serverXml.exists()) {
            return null;
        }
        try {
            return ServerConfigDropinXmlDocument.newInstance(serverXml);
     ...
     */
    private void removeGenerationCommentFromConfig(ServerConfigDropinXmlDocument doc, File serverXml) {
        if (doc == null) {
            return;
        }
        try {
     ...
     * Add a comment to server.xml to warn them we created another file with features in it.
     */
    private void addGenerationCommentToConfig(ServerConfigDropinXmlDocument doc, File serverXml) {
        if (doc == null) {
            return;
        }
        try {
