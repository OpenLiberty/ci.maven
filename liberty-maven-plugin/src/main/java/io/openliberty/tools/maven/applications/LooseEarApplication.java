...
public class LooseEarApplication extends LooseApplication {
    ...
    public Element addModule(MavenProject proj, Artifact artifact, String pluginId) throws IOException, MojoExecutionException {
        ...
        } catch (Exception looseApplicationException) {
            throw new MojoExecutionException("Problem configuring loose application", looseApplicationException);
        }


    }

    public Element addWarModule(MavenProject proj, Artifact artifact, File warSourceDir) throws IOException, MojoExecutionException {
        ...
        try {
            ...
            throw new MojoExecutionException("Problem configuring war manifest", javaLangException);
        }
    }
    ...
    public Element addRarModule(MavenProject proj, Artifact artifact) throws MojoExecutionException, IOException {
        ...
        try {
            ...
            throw new MojoExecutionException("Error adding manifest file" + manifestFile, exception);
        }
    ...
    public String getEarOutputFileNameMapping(Artifact artifact) throws MojoExecutionException {
        ...
        try {
            ...
            throw new MojoExecutionException("Error getting EarOutputFileNameMapping for artifact " + artifact, interpolationException);
        }
    }
