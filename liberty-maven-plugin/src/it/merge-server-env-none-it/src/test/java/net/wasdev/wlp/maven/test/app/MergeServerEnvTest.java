    ...
    public void check_server_env_contents() throws Exception {
        ...
        try (Scanner s = new Scanner(serverEnv)) {
           Map<String,String> serverEnvContents = new HashMap<String,String>();
            ...
            // Just confirm the keystore_password and ltpa_keys_password are present to prove the default server.env was maintained.
            Assert.assertTrue("Number of env properties should be <= 3, but is "+serverEnvContents.size(),  	serverEnvContents.size() <= 3);
