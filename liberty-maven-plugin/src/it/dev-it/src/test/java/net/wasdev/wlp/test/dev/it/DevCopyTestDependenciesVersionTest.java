...
public class DevCopyTestDependenciesVersionTest extends BaseDevTest {
   ...
   public static void setUpBeforeClass() throws Exception {
      ...
      String additionalConfiguration = "<copyDependencies> <dependency> <groupId>org.postgresql</groupId> <artifactId>postgresql</artifactId> <version>42.1.1</version> </dependency> </copyDependencies>";
   ...
   public void copyDependenciesTest() throws Exception {
      // File should be copied with the specified version (even though there is the same dependency with test scope)
      verifyLogMessageExists("copyDependencies copied file postgresql-42.1.1.jar to location", 2000);
