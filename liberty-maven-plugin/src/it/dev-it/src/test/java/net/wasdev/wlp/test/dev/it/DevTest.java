...
public class DevTest extends BaseDevTest {
   ...
   public void generateFeatureTest() throws Exception {
      ...
      final String RUNNING_GENERATE_FEATURES = "Running liberty:generate-features";
      ...
      assertTrue(verifyLogMessageExists(errMsg, 10000, errCount+1)); // wait for compilation
      ...
      writer.write("g\n");
      writer.flush();
      assertTrue(autoGenOn, verifyLogMessageExists(autoGenOn, 10000)); // allow time to run scanner
