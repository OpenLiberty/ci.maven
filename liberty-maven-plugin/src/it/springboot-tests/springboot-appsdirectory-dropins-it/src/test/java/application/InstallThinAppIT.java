...
public class InstallThinAppIT {
   
	@Test
	public void testThinApplicationExistsInDropinsDirectory() throws Exception {
	    
	    File f = new File("target/liberty/wlp/usr/servers/test/dropins/spring/thin-springboot-appsdirectory-dropins-it-1.0.0.Final.jar");
