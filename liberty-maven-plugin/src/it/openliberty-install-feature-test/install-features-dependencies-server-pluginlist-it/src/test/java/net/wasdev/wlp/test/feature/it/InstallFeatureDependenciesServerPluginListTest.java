...
public class InstallFeatureDependenciesServerPluginListTest extends BaseInstallFeature {
    ...
    public void testNumberOfFeatures() throws Exception {
        ...
        assertTrue("Feature a-1.0 was not installed", contains("a-1.0"));
        assertTrue("Feature b-1.0 was not installed", contains("b-1.0"));
        assertFalse("Feature c-1.0 was installed but should be skipped", contains("c-1.0"));
    }
