...
public class PackageTypeRunnableJarTest {
    ...
    private String projectBuildName = "package-type-config-with-space-it.jar";
    ...
    @Test
    public void testJarFileIsRunnable() {
        ...
        try {
            ...
            Assert.assertEquals("Expected Main-Class manifest value for runnable jar not found.","wlp.lib.extract.SelfExtractRun", value);
        } catch (Exception e) {
