...
public class LooseConfigTest {
    ...
    public void testXmlElements() throws Exception {
    	File in = new File("liberty/usr/servers/test/apps/default-appsdirectory-it.war.xml");
    ...
    public void testApplicationFileExist() throws Exception {
        File f = new File("liberty/usr/servers/test/apps/default-appsdirectory-it.war.xml");
