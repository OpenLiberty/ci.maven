...
public class PluginConfigXmlIT {
    ...
    public void testBootstrapPropertiesFileElements() throws Exception {
        ...
        Assert.assertEquals("Number of bootstrapPropertiesFile element ==>", 0, nodes.getLength());
        
        expression = "/liberty-plugin-config/bootstrapProperties";
        nodes = (NodeList) xPath.compile(expression).evaluate(inputDoc, XPathConstants.NODESET);
        Assert.assertEquals("Number of bootstrapProperties element ==>", 1, nodes.getLength());
        
        Assert.assertEquals("verify target server bootstrap.properties", "# Generated by liberty-maven-plugin\nlocation=pom.xml\n",
    ...
    public void testJvmOptionsFileElements() throws Exception {
        ...
        NodeList nodes = (NodeList) xPath.compile(expression).evaluate(inputDoc, XPathConstants.NODESET);
        Assert.assertEquals("Number of jvmOptionsFile element ==>", 0, nodes.getLength());
        
        expression = "/liberty-plugin-config/jvmOptions";
        nodes = (NodeList) xPath.compile(expression).evaluate(inputDoc, XPathConstants.NODESET);
        Assert.assertEquals("Number of jvmOptions element ==>", 1, nodes.getLength());
        
        Assert.assertEquals("verify target server jvm.options", "# Generated by liberty-maven-plugin\n-Xmx768m\n",
