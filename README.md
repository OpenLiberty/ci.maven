...
| Parameter | Description | Required |
| --------  | ----------- | -------  |
| config | Inlined content of a server configuration file to be used by the instance. If the parameter is specified the `configFile` parameter is ignored. | No |
...
Examples:
 ...
 1. Using a server configuration from the `server.xml` file.
...
```
 ...
 2. Using an inlined server configuration.
    ...
    <executions>
        ...
        <execution>
            ...
            <configuration>
                <config>
                    <![CDATA[
                    <server description="springServer">
                        <!-- Enable features -->
                        <featureManager>
                            <feature>servlet-3.1</feature>
                        </featureManager>
                        <httpEndpoint httpPort="${default.http.port}" httpsPort="${default.https.port}" id="defaultHttpEndpoint"/>
                       <webApplication id="${application.name}" location="${application.location}" name="${application.name}"/>
                    </server>]]>
                </config>
                <bootstrapProperties>
                    <httpPort>8080</httpPort>
