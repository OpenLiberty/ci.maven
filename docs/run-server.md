...
The run-server goal will update any [server configuration](common-server-parameters.md#common-server-parameters) files that were changed in the source directory. 
