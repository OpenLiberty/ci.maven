...
* `g` - toggle the automatic generation of features, type `g` and press Enter. Features will automatically be generated in a new file  of your application. A new server configuration file will be generated in the SOURCE configuration directory.
* `o` - optimize the list of generated features, type `o` and press Enter. A new server configuration file will be generated in the SOURCE configuration directory.
...
N.B. starting in 3.6, dev mode invokes `generate-features`. Ensure that the `generated-features.xml` configuration file is copied to your Docker image via your Dockerfile.
```dockerfile
