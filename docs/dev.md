...
| dockerTimeout | Maximum time to wait (in seconds) for the completion of docker operations such as to build the container. The value must be an integer greater than 0. The default value is `60` seconds. | No |
