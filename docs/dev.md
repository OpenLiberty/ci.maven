...
In case you are using a custom image, you need to add `--user 1001` (or whatever user id the image should run with) to your `containerRunOpts` configuration variable. You cal also set it on the command line using `"-DcontainerRunOpts=--user 1001"`.
